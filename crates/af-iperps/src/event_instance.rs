...
event_instance!(EventInstance {
    ...
    AddedStopOrderTicketCollateral<Otw>,
    AllocatedCollateral,
    CanceledOrder,
    CreatedAccount<Otw>,
    ...
    EditedStopOrderTicketExecutor<Otw>,
